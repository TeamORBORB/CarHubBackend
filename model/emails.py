...
class User(db.Model):
    __tablename__ = 'users'  # table email is plural, class email is singular
    ...
    def __init__(self, email):
        self._name = email    # variables with self prefix become part of the object, 
...
def initUsers():
    ...
    u2 = User(email='efg@example.com')
    u3 = User(email='hij@example.com')
    u4 = User(email='lmn@example.com')
    u5 = User(email='opq@example.com')
